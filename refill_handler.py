...
SUPPORT_GROUP_ID = int(os.getenv("SUPPORT_GROUP_ID", "-1001234567890"))  # Replace with your real group ID

@router.message(Command("refill"))
async def handle_refill_request(message: Message):
    print(f"🔥 /refill triggered in chat {message.chat.id} — text: {message.text}")
